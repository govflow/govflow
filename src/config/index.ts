...
const defaultSettings: AppSettings = {
    ...
    'storageBucket': process.env.STORAGE_PRESIGN_BUCKET || 'govflow_uploads',
    'storageRegion': process.env.STORAGE_PRESIGN_REGION || 'us-east-1',
    'storageSSL': Boolean(parseInt(process.env.STORAGE_PRESIGN_SSL || '1', 10)), // 0 or 1
    'storagePort': parseInt(process.env.STORAGE_PRESIGN_PORT || '9000', 10),
    'storageEndpoint': process.env.STORAGE_PRESIGN_ENDPOINT || '127.0.0.1',
    'storageAccessKey': process.env.STORAGE_PRESIGN_ACCESS_KEY || '',
    'storageSecretKey': process.env.STORAGE_PRESIGN_SECRET_KEY || '',
