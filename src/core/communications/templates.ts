export function serviceRequestStaffUserNewSubject(context: Record<string, string>): string {
    return `[${context.appName}]: A New Service Request Has Been Submitted`;
}

export function serviceRequestStaffUserNewBody(context: Record<string, string>): string {
...
export function serviceRequestStaffUserChangedAssigneeSubject(context: Record<string, string>): string {
    return `[${context.appName}]: You Have Been Assigned a Service Request`;
}

export function serviceRequestStaffUserChangedAssigneeBody(context: Record<string, string>): string {
    return `Hello ${context.recipientName},
    An open service request has been assigned to you. Go to ${context.appName}
    at ${context.appClientUrl} for further details.`;
}

export function serviceRequestStaffUserChangedStatusSubject(context: Record<string, string>): string {
    return `[${context.appName}]: A Service Request Has Been Closed`;
}

export function serviceRequestStaffUserChangedStatusBody(context: Record<string, string>): string {
    return `Hello ${context.recipientName},
...
export function serviceRequestPublicUserClosedSubject(context: Record<string, string>): string {
    return `[${context.appName}]: A Service Request Has Been Closed`;
}

export function serviceRequestPublicUserClosedBody(context: Record<string, string>): string {
    return `Hello ${context.recipientName},
